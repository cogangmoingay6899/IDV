              ...
              return (
                ...
                >
                  <div className="space-y-3">
                    ...
                    <div className="text-xs space-y-1 bg-slate-50 p-2.5 rounded-2xl border border-slate-100">
                      <div className="text-slate-700">
                        <span className="text-slate-400 font-semibold">Khóa đề xuất:</span>{' '}
                        <strong className="text-slate-900">{t.recommendedCourse}</strong>
                      </div>
                      {t.assignedClassName && (
                    ...
                    <div className="flex items-center gap-1.5 flex-wrap">
                      ...
                      {t.status === 'Không đạt' ? (
                        <button
                          ...
                          className="inline-flex items-center gap-1 px-2.5 py-1.5 text-xs font-bold text-emerald-700 bg-emerald-50 hover:bg-emerald-100 border border-emerald-200 rounded-xl transition-all"
                          title="Chuyển trạng thái sang Đã đạt"
                        >
                          <CheckCircle2 className="w-3.5 h-3.5 text-emerald-600" />
                          <span>Chuyển Đạt</span>
                        </button>
                      ) : (
                        <button
                          type="button"
                          onClick={() => handleStatusChange(t, 'Không đạt')}
                          className="inline-flex items-center gap-1 px-2.5 py-1.5 text-xs font-bold text-rose-700 bg-rose-50 hover:bg-rose-100 border border-rose-200 rounded-xl transition-all"
