...
export const INITIAL_CLASSES: ClassGroup[] = [
  {
    ...
    "assistantTeacherName": "Trần Thùy Linh (TA)",
    "room": "P.201 - Kiến An",
  ...
  },
  {
    ...
    "teacherName": "Minh Tâm",
    "assistantTeacherName": "Nguyễn Hoàng Nam (TA)",
    "room": "P.102 - Tô Hiệu",
...
export const INITIAL_PLACEMENT_TESTS: PlacementTest[] = [
  {
    ...
    comment: 'Từ vựng phong phú, phản xạ Speaking lưu loát, ngữ pháp chắc. Cần rèn thêm Task 2 Writing dạng Discussion.',
    sourceType: 'google_form_link',
    googleFormLink: 'https://docs.google.com/forms/d/e/1FAIpQLSfIDVIELTSPlacementTest/viewform',
    speakingAudioUrl: '/audio/guitar_lesson_listening.mp3',
    speakingAudioDuration: 45,
  },
  {
    id: 'pt-102',
    code: 'TEST-102',
    candidateName: 'Đặng Tuấn Phong',
    dob: '2007-11-20',
    gender: 'Nam',
    phone: '0977665544',
    email: 'tuanphong.dang@gmail.com',
    parentName: 'Đặng Quốc Huy',
    parentPhone: '0903445566',
    address: 'Lê Chân, Hải Phòng',
    testDate: '2026-05-18',
    evaluatorName: 'Minh Tâm',
    listeningScore: 5.0,
    speakingScore: 4.5,
    readingScore: 5.5,
    writingScore: 4.5,
    ...
    status: 'Đã xếp lớp chờ',
    comment: 'Phát âm cơ bản tốt, thiếu vốn từ học thuật (Collocations), cần ôn luyện nền tảng trước khi lên Intensive.',
    sourceType: 'form_online',
    speakingAudioUrl: '/audio/guitar_lesson_listening.mp3',
    speakingAudioDuration: 38,
  },
  {
    id: 'pt-103',
    code: 'TEST-103',
    candidateName: 'Phạm Thảo My',
    dob: '2009-02-10',
    gender: 'Nữ',
    phone: '0966554433',
    email: 'thaomy.pham09@gmail.com',
    parentName: 'Nguyễn Thị Thu',
    parentPhone: '0936112233',
    address: 'Ngô Quyền, Hải Phòng',
    testDate: '2026-05-19',
    evaluatorName: 'Thơm Nguyễn',
    listeningScore: 4.0,
    speakingScore: 3.5,
    readingScore: 4.5,
    writingScore: 3.5,
    ...
    comment: 'Học sinh mới làm bài test trực tuyến Google Form, chờ giáo viên phỏng vấn Speaking 1-1.',
    sourceType: 'form_online',
  }
];
